...
<div class="row">
    <div class="col-md-9">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="text-center text-primary" style="color: rgb(99, 107, 111);"><b>Category: {{$category->name}}</b></h4>
            </div>
                ...
                <ul class="list-group" style="padding: 3px;">
                    @foreach($category->articles as $article)
                        @if($article->public == 1)
                            ...
                            </h5>                                    <p style="font-size: 15px;">{!! \Illuminate\Support\Str::words($article->text, 70, '....')  !!}</p>
    ...
    <div class="col-md-3">
        <div class="panel panel-default text-center" style="margin-top: 1px;">
            <div class="panel-body">
                <p class="text-center"><a class="btn btn-success" role="button" href="/articles/create/{{$category->id}}">Write New Article</a></p>
